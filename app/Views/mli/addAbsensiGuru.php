    ...
    <main class="app-main">
      ...
      <div class="app-content-header">
        ...
        <div class="container-fluid">
          <!--begin::Row-->
           <div class="row">
            <div class="col-sm-6"><h3 class="mb-0">Guru Attendance</h3></div>
            <div class="col-sm-6">
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            ...
            <div class="card">
              ...
              <form action="<?php echo base_url(); ?>absensiguru" method="post">
              <div class="row">
                <div class="col-sm-3">
              ...
              <div class="card-body">
                ...
                <table class="table table-bordered">
                  ...
                  <tbody>
                    <?php for ($i = 0; $i < count($data); $i++) { ?>
                      <tr>
                        <td ><?= $data[$i]->guru_id ?></td>
                        <td><?= $data[$i]->guru_nama ?></td>
                        
                        <td>
                          <input type="hidden" name="guru_id[]" value="<?= $data[$i]->guru_id ?>">
                ...
                <br>
                 ...
                 <a href="<?php echo base_url() ?>absensiguru" class="btn btn-danger">Cancel</a>
