				...
				<tbody>
					...
					<tr>
						...
						<td class="condensed">
									...
									<select name="select_kelompok" id="select_kelompok" class="form-control">
		...
		<div class="col-lg-10 offset-lg-1">
			...
			<table class="table table-bordered border-dark">
				...
				<tbody>
					...
					<tr>
						<th class="condensed">Nama Guru</th>
						<td class="condensed" id="nama_guru_2"></td>
					</tr>
					<tr>
						<th class="condensed">Kelompok Usia</th>
						<td class="condensed">auto</td>
					</tr>
...
- Pembiasaan Cuci Tangan Sebelum dan Sesudah Makan
- Makan Bekal Bersama
- Bermain
							</textarea>
						</td>
